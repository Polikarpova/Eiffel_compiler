...
public:
	...
	/** ѕроверка на возможность приведени€ к более общему типу.
		...
		ѕо умолчанию тип не может быть приведЄн ни к чему, -- подклассы могут расширить это поведение.
	*/
	virtual bool canCastTo(const EiffelType* otherType) { return false; }
};
